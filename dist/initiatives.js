...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/asyncToGenerator */ \"./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js\");\n/* harmony import */ var _global_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./global.js */ \"./src/scripts/global.js\");\n/* harmony import */ var _global_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_global_js__WEBPACK_IMPORTED_MODULE_1__);\nfetch(\"\".concat(_global_js__WEBPACK_IMPORTED_MODULE_1__.backend,\"./initiatives\"),{method:\"POST\",headers:{\"Content-Type\":\"application/json\"}}).then(/*#__PURE__*/function(){var _ref=(0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(function*(data){data=yield data.json();var leads=Array.from(new Set(data.flatMap(el=>el.leads)));var leadsObj={};yield fetch(\"\".concat(_global_js__WEBPACK_IMPORTED_MODULE_1__.backend,\"./translate-user-ids\"),{method:\"POST\",headers:{\"Content-Type\":\"application/json\"},body:JSON.stringify({user_ids:leads})}).then(/*#__PURE__*/function(){var _ref2=(0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(function*(data){var mapped=yield data.json(),i;for(i=0;i<leads.length;i++){leadsObj[leads[i]]=mapped[i]}});return function(){return _ref2.apply(this,arguments)}}());data=data.map(/*#__PURE__*/function(){var _ref3=(0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(function*(el){el.mins=parseInt(el.total_mins)%60;el.hours=Math.floor(parseInt(el.total_mins)/60);el.leads=el.leads.map(el=>leadsObj[el]);// Sanitize\nvar div=document.createElement(\"div\");div.innerText=el.description;el.description=div.innerHTML.replaceAll(\"<br>\",\"</div><div>\");// await fetch(`${backend}./translate-user-ids`, {\n// \tmethod: \"POST\",\n// \theaders: {\n// \t\t\"Content-Type\": \"application/json\",\n// \t},\n// \tbody: JSON.stringify({\n// \t\tuser_ids: el.leads,\n// \t}),\n// }).then(async (data) => {\n// \tel.leads = await data.json();\n// });\n// First name, last initial\n// el.leads = el.leads.map(el => {\n//   let split = el.split(\" \");\n//   if (split.length > 1){\n//     return `${split[0]} ${split.at(-1).slice(0,1)}.`\n//   }\n//   return split[0];\n// })\n// Sanitize\ndiv.innerText=el.leads.join(\", \");el.leads=div.innerHTML;div.innerText=el.initiative_name;el.initiative_name=div.innerHTML;// Initiative pictures used to be ${el.picture}\n// Both images should have same URL\nreturn\"<section>\\n  <div class=\\\"image-container\\\">\\n    <img src=\\\"./static/logos/logo_trans.png\\\">\\n  </div>\\n  <div class=\\\"info-container\\\" style=\\\"--img-url:url('./static/logos/logo_trans.png')\\\">\\n    <h2>\".concat(el.initiative_name,\"</h2>\\n    <div class=\\\"leads\\\">Leads: \").concat(el.leads,\"</div>\\n    <div class=\\\"stats\\\">\\n      <div class=\\\"participants\\\"><img src=\\\"./static/person-icon.png\\\" alt=\\\"Participants\\\">\\n        <span>\").concat(el.total_participants,\" volunteer\").concat(el.total_participants>1?\"s\":\"\",\"</span>\\n      </div>\\n      <div class=\\\"hours\\\"><img src=\\\"./static/clock-icon.png\\\" alt=\\\"Time Spent\\\">\\n        <span>\").concat(el.hours||el.mins,\" \").concat(el.hours?\"hour\".concat(el.hours)>1?\"s\":\"\":\"min\".concat(el.mins)>1?\"s\":\"\",\"</span>\\n      </div>\\n    </div>\\n    <div class=\\\"description\\\">\\n      <div>\").concat(el.description,\"</div>\\n    </div>\\n  </div>\\n</section>\")});return function(){return _ref3.apply(this,arguments)}}());Promise.all(data).then(data=>{(0,_global_js__WEBPACK_IMPORTED_MODULE_1__.$)(\".content\")[0].innerHTML+=data.join(\"\\n\")})});return function(){return _ref.apply(this,arguments)}}());\n\n//# sourceURL=webpack://outreach-website-frontend/./src/scripts/initiatives.js?");
